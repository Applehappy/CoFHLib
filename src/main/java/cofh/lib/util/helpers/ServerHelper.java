...
public final class ServerHelper {
	 ...
	 */
	public static final void sendItemUsePacket(ItemStack stack, EntityPlayer player, World world, BlockPos bp, EnumFacing hitSide, EnumHand hand, float hitX, float hitY, float hitZ) {
		...
		netClientHandler.sendPacket(new CPacketPlayerTryUseItemOnBlock(bp, hitSide, hand, hitX, hitY, hitZ));
	}
